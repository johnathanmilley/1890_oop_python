""" Purpose: An update to the ScoreKeeper App
    ...
    Features to add
        ...
        2. Add toolbar options for adding player-boards on the 2nd screen
        3. Add 'Help' menu option
        4. Add 'About' action to Help menu
        5. Bonus: Include a Remove action on the toolbar that removes player-boards from the 2nd screen
